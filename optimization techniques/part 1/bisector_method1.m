...
for i = 1:length(e_values)
    ...
    % Bisector Searches
    [~, ~, f1_count(i)] = bisectorSearch(f1, a_0, b_0, l, e);

    [~, ~, f2_count(i)] = bisectorSearch(f2, a_0, b_0, l, e);

    [~, ~, f3_count(i)] = bisectorSearch(f3, a_0, b_0, l, e);
end
...
function [a, b, eval_count] = bisectorSearch(f, a, b, l, e)
